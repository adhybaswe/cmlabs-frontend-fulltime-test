...
import { useAreas } from '@/services/mealQueries';
...
export default function LocalCulinaryPage() {
  ...
  if (isError) return <MainLayout><div className="text-center text-red-500">Error fetching areas</div></MainLayout>;
  ...
  return (
    <MainLayout>
      <header className="mb-12 text-center">
        ...
        <p className="text-gray-600 mb-8 text-lg">Discover recipes by their country of origin</p>
        <SearchBar 
          value={searchTerm} 
